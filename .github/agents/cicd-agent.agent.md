...
argument-hint: "e.g. Add GitHub Actions checks for this monorepo"
handoffs:
  - label: Document pipeline
    agent: documentation-agent
    prompt: Document the pipeline, checks, and local equivalents.
  - label: Review release path
    agent: release-manager
    prompt: Review the release workflow, artifacts, and rollback expectations.
