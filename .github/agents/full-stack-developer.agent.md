...
argument-hint: "e.g. Implement STORY-003 full stack"
handoffs:
  - label: Add tests
    agent: test-writer
    prompt: Add backend and frontend tests for the full-stack story.
  - label: Review changes
    agent: pr-reviewer
    prompt: Review the full-stack diff for security, API contract, and test gaps.
...
1. **Contract first** — document paths, JSON bodies, status codes (markdown or OpenAPI snippet).
