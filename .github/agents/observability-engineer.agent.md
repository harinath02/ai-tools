...
argument-hint: "e.g. Add observability for this API flow"
handoffs:
  - label: Tune performance
    agent: performance-agent
    prompt: Use the telemetry to investigate the performance issue.
  - label: Document runbook
    agent: documentation-agent
    prompt: Document the new metrics, alerts, and troubleshooting path.
