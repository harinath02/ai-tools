...
argument-hint: "e.g. Prepare this repo for a safe release"
handoffs:
  - label: Harden pipeline
    agent: cicd-agent
    prompt: Add or refine the release automation and artifact checks.
  - label: Document release
    agent: documentation-agent
    prompt: Document release notes, runbooks, and rollback steps.
